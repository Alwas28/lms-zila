<x-app-layout>
    ...
    <div class="mb-6">
        <nav class="flex items-center gap-1.5 text-xs text-slate-400 mb-1">
            ...
            <i class="fa-solid fa-chevron-right text-slate-300 text-xs"></i>
            <span class="text-ink-500 font-medium">Forum</span>
        </nav>
    ...
    <div class="bg-white rounded-2xl border border-slate-200 p-16 text-center">
        ...
        <p class="text-slate-400 text-sm">Mulai dengan membuat topik diskusi baru.</p>
    </div>
    @else
    <div class="bg-white rounded-2xl border border-slate-200 overflow-hidden">
        <div class="divide-y divide-slate-50">
            ...
            <div class="flex items-start gap-4 px-5 py-4 hover:bg-slate-50/50 transition-colors">
                <div class="w-9 h-9 rounded-xl flex items-center justify-center text-white font-semibold text-sm flex-shrink-0 mt-0.5
                    {{ $t->penulis->isDosen() ? 'bg-ink-600' : 'bg-sage-500' }}">
                ...
                <div class="flex-1 min-w-0">
                    <div class="flex items-center gap-2 flex-wrap mb-0.5">
                        ...
                        @endif
                        <a href="{{ route('mahasiswa.forum.show', [$kelas, $t]) }}"
                    ...
                    <div class="flex items-center gap-3 text-xs text-slate-400 mt-1">
                        ...
                        @if($t->penulis->isDosen())<span class="text-ink-500 font-medium">Dosen</span>@endif
                        <span>&middot;</span>
    ...
    <div id="modal-buat" class="hidden fixed inset-0 z-50 items-center justify-center p-4">
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg">
            ...
            <form action="{{ route('mahasiswa.forum.store', $kelas) }}" method="POST" class="px-6 py-5 space-y-4">
                @csrf
                <div>
